...
- 폴더 `./private`에 [config.js](#config.js)파일을 **반드시** 만들어 주세요. 본 레포지토리에는 각 파일의 양식이 들어가 있습니다.
...
- Please create [config.js](#config.js) file in the folder `./private`. This repertoire contains forms for [config.js](#config.js) file
